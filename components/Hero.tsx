...
const Hero: React.FC<HeroProps> = ({ data }) => {
  // Fallback data
  const heroData = data || {
    badgeText: "Pilihan Wargi Tasik & Indonesia",
    headlineLine1: "Urus Bisnis Jadi",
    headlineLine2: "Lebih Santuy & Cuan",
    description:
    ...
    primaryCta: "Cobain Gratis",
    secondaryCta: "Cek Paket Hemat",
    highlight1: "Free Tier Selamanya",
    highlight2: "Bisa Offline",
    highlight3: "Support Gercep",
  };
              ...
              <div className="rounded-2xl overflow-hidden bg-slate-800 border border-slate-700/50 relative backdrop-blur-xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative z-10 bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl text-center shadow-2xl">
                    ...
                    <p className="text-slate-200 text-base mt-3 font-medium">
                      Pantau jualan tanpa ribet!
                    </p>
                  </div>
                </div>
              </div>
